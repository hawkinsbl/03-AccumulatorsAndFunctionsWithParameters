...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher, Mark Hays,
         Aaron Wilkin, their colleagues, and Ben Hawkuns.
...
#           Updates then draws all shapes on the canvas
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#          So that the window does not immediately close
#
